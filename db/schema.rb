...
ActiveRecord::Schema[7.0].define(version: 2023_06_26_104852) do
  ...
  create_table "logs", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["assigner_id"], name: "index_logs_on_assigner_id"
    t.index ["runner_id"], name: "index_logs_on_runner_id"
